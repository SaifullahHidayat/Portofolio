                ...
                <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    >
                      {project.liveUrl && (
                        <a
                          ...
                          className="p-3 rounded-full bg-accent-cyan text-background-primary
                      ...
                      {project.githubUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="p-3 rounded-full bg-white/10 text-text-primary border border-white/20
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="px-2.5 py-1 rounded-full text-xs font-medium bg-accent-purple/10 text-accent-purple border border-accent-purple/20">
                        {project.category}
                      </span>
                    </div>
