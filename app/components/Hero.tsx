    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="flex flex-col items-center">
          ...
          <motion.h1 variants={itemVariants} className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-text-primary mb-6">
            Hi, I&apos;m {personalInfo.name}
          </motion.h1>

          <motion.h2 variants={itemVariants} className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-8">
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 mb-12">
            <a href="#projects" className="px-8 py-3.5 rounded-full bg-gradient-accent text-background-primary font-semibold hover:shadow-glow transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]">
              View My Work
            </a>
            <a href="#contact" className="px-8 py-3.5 rounded-full border border-white/20 text-text-primary font-semibold hover:bg-white/5 hover:border-accent-cyan/50 transition-all duration-300">
              Contact Me
            </a>
          </motion.div>
